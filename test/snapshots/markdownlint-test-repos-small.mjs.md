...
> Expected linting violations
    ...
    `test-repos/apache-airflow/clients/python/CHANGELOG.md: 72: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.10.0"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 92: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.9.1"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 99: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.9.0"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 118: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.8.0"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 141: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.7.3"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 152: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.7.2"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 168: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.7.0"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 191: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.6.2"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 207: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.6.1"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 223: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.6.0"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 246: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.5.1"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 262: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.5.0"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 282: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.3.0"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 300: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.2.0"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 321: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.1.0"]␊
    test-repos/apache-airflow/clients/python/CHANGELOG.md: 342: MD025/single-title/single-h1 Multiple top-level headings in the same document [Context: "v2.0.0"]␊
...
> Expected linting violations
    ...
    test-repos/electron-electron/docs/api/app.md: 697: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/electron-electron/docs/api/app.md: 699: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/electron-electron/docs/api/session.md: 839: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    ...
    test-repos/electron-electron/docs/breaking-changes.md: 1294: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/electron-electron/docs/breaking-changes.md: 1852: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/electron-electron/docs/breaking-changes.md: 1873: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/electron-electron/docs/breaking-changes.md: 1977: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/electron-electron/docs/breaking-changes.md: 2125: MD059/descriptive-link-text Link text should be descriptive [Context: "[link]"]␊
    ...
    test-repos/electron-electron/docs/development/creating-api.md: 162: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    ...
    test-repos/electron-electron/docs/tutorial/electron-timelines.md: 92: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
...
> Expected linting violations
    ...
    test-repos/mochajs-mocha/docs/index.md: 1260: MD051/link-fragments Link fragments should be valid [Context: "[\`--parallel\`](#-parallel-p)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1278: MD051/link-fragments Link fragments should be valid [Context: "[\`--node-option\`](#-node-option-name-n-name)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1299: MD051/link-fragments Link fragments should be valid [Context: "[\`--node-option\`](#-node-option-name-n-name)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1305: MD051/link-fragments Link fragments should be valid [Context: "[\`--parallel\`](#-parallel-p)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1330: MD051/link-fragments Link fragments should be valid [Context: "[\`--grep\`](#-grep-regexp-g-regexp)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1330: MD051/link-fragments Link fragments should be valid [Context: "[\`--fgrep\`](#-fgrep-string-f-string)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1341: MD051/link-fragments Link fragments should be valid [Context: "[\`--file\`](#-file-file)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1342: MD051/link-fragments Link fragments should be valid [Context: "[\`--sort\`](#-sort-s)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1348: MD051/link-fragments Link fragments should be valid [Context: "[globally](#-timeout-ms-t-ms)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1409: MD051/link-fragments Link fragments should be valid [Context: "[\`--parallel\`](#-parallel-p)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1416: MD051/link-fragments Link fragments should be valid [Context: "[\`--timeout\`](#-timeout-ms-t-ms)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1426: MD051/link-fragments Link fragments should be valid [Context: "[job count](#-jobs-count-j-count)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1440: MD051/link-fragments Link fragments should be valid [Context: "[\`--require\`](#-require-module-r-module)"]␊
    test-repos/mochajs-mocha/docs/index.md: 1650: MD051/link-fragments Link fragments should be valid [Context: "[\`--parallel\`](#-parallel-p)"]␊
    test-repos/mochajs-mocha/docs/index.md: 2130: MD051/link-fragments Link fragments should be valid [Context: "[Watch mode](#-watch-w)"]␊
    test-repos/mochajs-mocha/docs/index.md: 2425: MD053/link-image-reference-definitions Link and image reference definitions should be needed [Unused link or image reference definition: "caniuse-notifications"] [Context: "[caniuse-notifications]: https..."]␊
    test-repos/mochajs-mocha/docs/index.md: 2426: MD053/link-image-reference-definitions Link and image reference definitions should be needed [Unused link or image reference definition: "caniuse-promises"] [Context: "[caniuse-promises]: https://ca..."]␊
    test-repos/mochajs-mocha/docs/index.md: 2457: MD053/link-image-reference-definitions Link and image reference definitions should be needed [Unused link or image reference definition: "mocha-website"] [Context: "[mocha-website]: https://mocha..."]␊
    test-repos/mochajs-mocha/docs/index.md: 2226: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/mochajs-mocha/docs/index.md: 2296: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]`
