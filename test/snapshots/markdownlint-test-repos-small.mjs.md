...
> Expected linting violations
    ...
    test-repos/electron-electron/docs/breaking-changes.md: 1257: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/electron-electron/docs/breaking-changes.md: 1815: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/electron-electron/docs/breaking-changes.md: 1836: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/electron-electron/docs/breaking-changes.md: 1940: MD059/descriptive-link-text Link text should be descriptive [Context: "[here]"]␊
    test-repos/electron-electron/docs/breaking-changes.md: 2088: MD059/descriptive-link-text Link text should be descriptive [Context: "[link]"]␊
