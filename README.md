...
* **[MD041](doc/Rules.md#md041)** *first-line-heading/first-line-h1* - The first line in the file should be a top-level heading
...
bad.string: 1: MD041/first-line-heading/first-line-h1 The first line in the file should be a top-level heading [Context: "#bad.string"]
...
bad.md: 1: MD041/first-line-heading/first-line-h1 The first line in the file should be a top-level heading [Context: "#bad.md"]
```
...
```json
{
  ...
  "bad.md": [
    ...
    { "lineNumber": 1,
      ...
      "ruleDescription": "The first line in the file should be a top-level heading",
