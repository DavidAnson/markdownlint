...
/**
 * Return the string representation of a emphasis markup character.
 *
 * @param {string} markup Emphasis string.
 * @returns {string} String representation.
 */
module.exports.emphasisStyleFor =
  function emphasisStyleFor(markup) {
    switch (markup[0]) {
      case "*":
        return "asterisk";
      default:
